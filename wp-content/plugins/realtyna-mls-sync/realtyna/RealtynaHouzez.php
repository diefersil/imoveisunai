...
class RealtynaHouzez {
    ...
    public static function isHouzezThemeActive(){
        ...
        $themeName = strtolower( get_stylesheet() );

        return ( substr( $themeName , 0 , 6 ) == 'houzez' ) ;
    ...
    public static function houzezThemeExists(){
        ...
        return ( $theme->exists() || self::isHouzezThemeActive() );

    }

    /**
     * Validate Houzez Client
     * 
     * @author Chris A <chris.a@realtyna.net>
     * 
     * @return bool
    ...
    public static function validateClient()
    {
        ...
        if ( function_exists('get_option') ){
            ...
            $purchaseCode = get_option('houzez_purchase_code');
            $houzezActivated = get_option('houzez_activation');

            $isValidClient = ( !empty( $purchaseCode ) && ( $houzezActivated == 'activated' ) );
