...
class RealtynaMlsSync {
    ...
    public function __construct() {
        ...
        register_activation_hook( static::getPluginBasename() , array( $this, 'activatePlugin'));
        register_deactivation_hook( static::getPluginBasename() , array( $this, 'deactivatePlugin' ) );
    ...
    public function screenSettings(){
        ...
        if ( class_exists('RealtynaView') ){
            ...
            $agencies = RealtynaHouzezAgency::get();
    ...
    private function ajaxResponseSettings( $params ){
            ...
            isset( $params['image_option'] ) )
        {
            ...
            if ( $params['apply_agency_to_all'] == "true" )
                $this->update_properties_agency( $params['agency'] );
    ...
    private function ajaxResponseClientInfo( $params ){
            ...
            !empty( $params['role'] ) )
        {
            ...
            if ( $this->getCredentials() === false ){
                ...
                $params['source'] = RealtynaHouzezMapper::getClientTheme();
     ...
     * @return bool
     */
    private function update_properties_agency( $agency ){
    ...
    public function setScheduler()
    {
        ...
        if ( class_exists('RealtynaMlsSyncDashboard') ){

            $dashboard = new RealtynaMlsSyncDashboard( $this->getCredentialToken() , $this->getCredentialUser() );
